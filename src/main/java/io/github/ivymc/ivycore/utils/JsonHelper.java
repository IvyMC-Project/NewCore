...
public class JsonHelper {
    ...
    public static JsonObject writeJsonObject(JsonObject data, Path filePath) throws IOException {
        var file = filePath.toFile();
        return jsonWriter(data,file);
    }

    public static JsonObject writeJsonObject(Object data, Path filePath) throws IOException {
